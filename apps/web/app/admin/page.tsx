...
import { Button, Card, CopyButton, Group, Pagination, ScrollArea, Select, SimpleGrid, Table, Text, TextInput } from '@mantine/core';
  ...
  return (
    <AppFrame title="Admin" subtitle="Role management, secure onboarding and invite links.">
      ...
      <Card withBorder radius="md" mb="md">
        ...
        <ScrollArea>
          <Table withTableBorder withColumnBorders miw={820}>
