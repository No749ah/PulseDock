    ...
    <div className="min-h-screen flex items-center justify-center p-8">
      <div className="text-center space-y-4 max-w-sm">
        ...
        <div className="space-y-1">
          <h2 className="text-xl font-semibold text-text-primary">Invite error</h2>
          <p className="text-sm text-text-secondary">This invite link may be expired or invalid.</p>
        </div>
