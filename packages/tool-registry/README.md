...
Pre-configured version check library for 2500+ self-hosted tools. Used by the PulseDock API to power the Tool Picker in the version monitor create flow.

## What's Included

- **2500+ tools** across 20+ categories
