<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/tests-1989%20passing-brightgreen" alt="Tests: 1989 passing" />
...
npm run test              # Run all tests (1989+ tests)
...
PulseDock has **1989+ tests** across the full stack:

```bash
npm run test                        # All tests
npm run test -w @pulsedock/api      # API tests only (1967 tests)
