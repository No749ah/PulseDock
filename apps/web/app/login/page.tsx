...
export default function LoginPage() {
  ...
  useEffect(() => {
    api<{ github: boolean; google: boolean }>("/v1/auth/oauth-configured")
      .then((r) => setOauthProviders(r))
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <FadeIn>
        <div className="w-full max-w-xl sm:max-w-2xl lg:max-w-3xl">
          ...
          {/* OAuth2 / SSO buttons */}
          {!totpStep && !inInviteFlow && !inResetFlow && !forgotMode && (oauthProviders.github || oauthProviders.google) && (
            <div className="mt-6">
