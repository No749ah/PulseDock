...
export interface MonitorItem {
  ...
  type: "HTTP" | "GIT_RELEASE" | "DOCKER_IMAGE" | "TCP" | "SSL_CERT" | "HEARTBEAT" | "DNS" | "PING" | "SMTP" | "BROWSER" | "WHOIS" | "FTP" | "IMAP" | "POP3" | "CT_LOG" | "GRAPHQL";
  target: string;
  intervalSec: number;
...
export type MonitorFormData = {
  ...
  description: string;
  runbookUrl: string;
  type: "HTTP" | "TCP" | "SSL_CERT" | "HEARTBEAT" | "DNS" | "PING" | "SMTP" | "BROWSER" | "WHOIS" | "FTP" | "IMAP" | "POP3" | "CT_LOG" | "GRAPHQL";
  target: string;
  intervalSec: number;
  confirmations: number;
  retryCount: number;
