    ...
    <main style={{ maxWidth: 1200, margin: '0 auto', padding: 'clamp(12px, 3vw, 24px)' }}>
      <Card withBorder radius="xl" p="xl" mb="md" style={{ background: 'rgba(14,20,40,0.75)', backdropFilter: 'blur(10px)' }}>
        <Stack gap="md">
          ...
          <Title order={1} style={{ fontSize: 'clamp(2rem, 5.2vw, 3.25rem)', lineHeight: 1.05, letterSpacing: '-0.03em' }}>
          ...
          <Group gap="sm" wrap="wrap">
            <Button color="teal" size="md" style={{ minWidth: 150, flex: '1 1 180px' }} onClick={() => router.push('/login')}>Get Started</Button>
            <Button color="teal" variant="light" size="md" style={{ minWidth: 150, flex: '1 1 180px' }} onClick={() => router.push('/dashboard')}>Open Dashboard</Button>
          </Group>
        </Stack>
      </Card>
