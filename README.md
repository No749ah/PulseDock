<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/tests-2200%2B%20passing-brightgreen" alt="Tests: 2200+ passing" />
...
npm run test              # Run all tests (2200+ tests)
...
PulseDock has **2200+ tests** across the full stack:

```bash
npm run test                        # All tests
npm run test -w @pulsedock/api      # API tests only (2216 tests)
