<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/tests-1979%20passing-brightgreen" alt="Tests: 1979 passing" />
...
npm run test              # Run all tests (1979+ tests)
...
PulseDock has **1979+ tests** across the full stack:

```bash
npm run test                        # All tests
npm run test -w @pulsedock/api      # API tests only (1957 tests)
